...
Instead, report them privately using [GitHub's private vulnerability reporting](https://github.com/getloko/loko-releases/security/advisories/new) in the relevant repository.
...
| Repository | In scope |
|------------|----------|
| [loko-releases](https://github.com/getloko/loko-releases) | CLI, generator, runner, plugins (source developed privately; report here) |
